...
# Normalize text formatting and safely clear internal raw newline text tags
...
# Exact system parameter strings mapped to your new schema rules
...
# Isolate the 6 explicit independent candidate columns present in this dataset
independent_cols = ['Independent', 'Independent.1', 'Independent.2', 'Independent.3', 'Independent.4', 'Independent.5']
...
for sheet in wb.worksheets:
    ...
    # 2. FIX: Safely unpack and auto-adjust widths by targeting cell objects inside the tuple
    for col in sheet.columns:
        max_len = max(len(str(cell.value or '')) for cell in col)
        
        # Pull the column letter using the first cell object's column attribute
