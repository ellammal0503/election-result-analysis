...
# ==============================================================================
# STEP 1: DEFINE SYSTEM CONFIGURATION (Mapped exactly to your new schema)
# ==============================================================================
party_config = {
    ...
    'vishwa tamil kazhagam': {'label': 'VTK', 'color': '#FF9800'}, # Added from your new dataset
    ...
    'independent.5': {'label': 'IND6', 'color': '#D1D5DB'}, # Expanded to match Independent.5
    'independent.6': {'label': 'IND7', 'color': '#E5E7EB'}, # Expanded to match Independent.6
    'independent.7': {'label': 'IND8', 'color': '#F3F4F6'}  # Expanded to match Independent.7
}
...
raw_building_col = 'building in which it will be located'
...
for sheet in wb.worksheets:
    for col in sheet.columns:
        max_len = 0
        col_letter = get_column_letter(col[0].column if isinstance(col, tuple) else col.column)
