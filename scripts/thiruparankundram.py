...
# Clean column headers immediately to remove whitespace irregularities
df.columns = df.columns.str.replace(r'\s+', ' ', regex=True).str.strip().str.lower()

# ==============================================================================
# STEP 1: DEFINE SYSTEM CONFIGURATION (Mapped to your exact index)
# ==============================================================================
party_config = {
    ...
    'puthiya tamilagam': {'label': 'PT', 'color': '#FF9800'},
    'tamizhaga vaazhvurimai katchi': {'label': 'TVK-TV', 'color': '#00897B'},
    'all india puratchi thalaivar makkal munnettra kazhagam': {'label': 'AIPTMMK', 'color': '#7B1E1E'},
    'tamilaga vettri kazhagam': {'label': 'TVK', 'color': '#4A148C'},
    'ezhuchi tamilargal munnetra kazhagam': {'label': 'ETMK', 'color': '#E65100'},
    'rashtriya samaj dal (r)': {'label': 'RSD(R)', 'color': '#01579B'},
...
# Extract explicit string values instead of operating on dynamic list types
...
vote_cols_to_cast = party_columns + ['total of valid votes', 'nota', 'total']
...
building_raw_col = 'location and name of building in which polling station located'
